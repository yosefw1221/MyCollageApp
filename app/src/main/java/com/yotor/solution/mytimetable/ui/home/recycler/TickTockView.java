...
public class TickTockView extends View {
    ...
    private int mCircleDuration = DURATION_TOTAL;
    ...
    public  void setCircleDuration(boolean fulltime){
        if (fulltime)mCircleDuration = DURATION_TOTAL;
    }
    public void setCounterDirection(boolean mCounterClockwise){
        this.mCounterClockwise = mCounterClockwise;
    }
    /**
     *
